...
public class DtMahaiswa extends javax.swing.JFrame {
    ...
    Connection iwan = koneksii.BukaKoneksi();
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        ...
        try {
            ...
            if (btnsimpan.getText()=="Simpan") {
                ...
                String cek ="SELECT * FROM MHS WHERE kode = '" + txtkodeMahasiswa.getText()+"'";
                rs = st.executeQuery(cek);
                if (rs.next()) {
                    JOptionPane.showMessageDialog(null,"Kode Barang Sudah dipakai");
                }else{
                   
                    String sql = "INSERT INTO MHS VALUES('" + txtkodeMahasiswa.getText()+
            ...
            JOptionPane.showMessageDialog(this,"Pilih data yang ingin dihapus");
             ...
             if (jawab ==0) {
                 try {
                     ...
                     String sql = "DELETE FROM MHS WHERE kode = '"+ txtkodeMahasiswa.getText()+"'";
                     st.executeUpdate(sql);
